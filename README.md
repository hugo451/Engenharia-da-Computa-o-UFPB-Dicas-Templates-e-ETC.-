...
### 1º Período
   ...
   - **INTRODUÇÃO À LINGUAGEM DE PROGRAMAÇÃO PARA ENGENHARIA DE COMPUTAÇÃO**:
   - **LABORATÓRIO DE INTRODUÇÃO A PROGRAMAÇÃO**:
   - **MATERIAIS PARA MICRO E NANO TECNOLOGIA**:
   - **METODOLOGIA DO TRABALHO CIENTÍFICO**:

### 2º Período
   - **CÁLCULO DIFERENCIAL E INTEGRAL II**:
   - **CIRCUITOS LOGICOS I**:
   - **ELETRICIDADE E CIRCUITOS PARA COMPUTAÇÃO I**:
   - **FÍSICA APLICADA À COMPUTAÇÃO I**:
   - **FÍSICA EXPERIMENTAL PARA COMPUTAÇÃO**:
   - **LINGUAGEM DE PROGRAMAÇÃO I**:
   - **LABORATORIO DE LINGUAGEM DE PROGRAMAÇÃO I**:
